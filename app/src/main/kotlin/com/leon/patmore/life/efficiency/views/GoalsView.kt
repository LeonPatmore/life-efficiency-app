...
class GoalsView(view: View,
                button: Button,
                private val lifeEfficiencyClient: LifeEfficiencyClient,
                private val context: Context,
                private val list: ListView) : ActiveView(view, button) {

    override fun onActive() {
        val goals = getGoalsAsList()
        val listAdapter = object: ArrayAdapter<Triple<String, String, Goal>>(context, R.layout.simple_list_item, goals) {
