...
class ShoppingListViewManager(private val lifeEfficiencyClient: LifeEfficiencyClient,
                              private val autoCompleteService: AutoCompleteService) : ViewManager {
    ...
    private fun setupAddItemButton(addItemText: AutoCompleteTextView, view: View, rootContext: Context) {
    ...
    private fun refreshItems(rootView: View, rootContext: Context) {
        ...
        val listAdapter = object: ArrayAdapter<ListItem>(rootContext, R.layout.list_item, listItems) {
